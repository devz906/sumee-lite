...
class PicoDriveAudio: ObservableObject {
    static let shared = PicoDriveAudio()
    ...
    private var bufferCapacity: Int = 32768
    ...
    func start(rate: Double) {
        ...
        print("🔊 [PicoDriveAudio] Core Rate: \(rate)Hz. Engine Mixer Rate: \(engineFormat.sampleRate)Hz")
        ...
        do {
            ...
            print("[PicoDriveAudio] Engine started successfully")
        } catch {
            print(" [PicoDriveAudio] Start error: \(error)")
        }
    }
